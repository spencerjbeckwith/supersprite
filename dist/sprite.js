...
const supersprite = {
    ...
    initialize: function (options) {
        ...
        this.cv1.width = (options === null || options === void 0 ? void 0 : options.displayWidth) || (options === null || options === void 0 ? void 0 : options.viewWidth) || window.innerWidth;
        this.cv1.height = (options === null || options === void 0 ? void 0 : options.displayHeight) || (options === null || options === void 0 ? void 0 : options.viewHeight) || window.innerHeight;
        ...
        this.gl = this.cv1.getContext('webgl', {
            antialias: (options === null || options === void 0 ? void 0 : options.antialias) || false,
        });
        if (!this.gl) {
        ...
        // Set our options
        if (options === null || options === void 0 ? void 0 : options.responsive) {
            this.responsive = options.responsive;
        }
        if (options === null || options === void 0 ? void 0 : options.maintainAspectRatio) {
            this.maintainAspectRatio = options.maintainAspectRatio;
        }
        if (options === null || options === void 0 ? void 0 : options.scalePerfectly) {
            this.scalePerfectly = options.scalePerfectly;
        }
        if (options === null || options === void 0 ? void 0 : options.contextImageSmoothing) {
            this.contextImageSmoothing = options.contextImageSmoothing;
        }
        // Prepare default shaders with their attributes, uniforms, etc.
        this.shaders.image = new Shader(this, imageShaderVertex, imageShaderFragment, function () {
            // IMAGE USE FUNCTION
        ...
        let tempUniform = gl.getUniformLocation(this.shaders.image.program, 'u_positionMatrix');
        if (tempUniform) {
            this.shaders.image.uniforms.positionMatrix = tempUniform;
        }
        tempUniform = gl.getUniformLocation(this.shaders.image.program, 'u_texcoordMatrix');
        if (tempUniform) {
            this.shaders.image.uniforms.textureMatrix = tempUniform;
        }
        tempUniform = gl.getUniformLocation(this.shaders.image.program, 'u_blend');
        if (tempUniform) {
            this.shaders.image.uniforms.blend = tempUniform;
        }
        tempUniform = gl.getUniformLocation(this.shaders.image.program, 'u_image');
        if (tempUniform) {
            this.shaders.image.uniforms.image = tempUniform;
        }
        ...
        this.shaders.primitive = new Shader(this, primitiveShaderVertex, primitiveShaderFragment, function (positions) {
        ...
        if (tempUniform) {
            this.shaders.primitive.uniforms.positionMatrix = tempUniform;
        }
        tempUniform = gl.getUniformLocation(this.shaders.primitive.program, 'u_blend');
        if (tempUniform) {
            this.shaders.primitive.uniforms.blend = tempUniform;
        }
